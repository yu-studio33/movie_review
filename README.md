...
- 
## デザイン
黒を基調としたダークテーマに、ピンク(#FF7FD4)をアクセントカラーとして使用しています。シックな黒背景に映えるビビッドなピンクを差し色にすることで、洗練された印象を目指しました。フォントはヘッダーロゴにArchivo Narrow、本文にNoto Sans JPを使用しています。トップページは「あなたへのおすすめ」「新着映画」「人気の映画」をセクションごとに分け、主要動画配信サービスのUI設計を参考にしています。
